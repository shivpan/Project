...
app.post("/empsearch", async (req, res) => {
  try {
  const { token } = req.body;
  //const tr = console.log(domain)
  // const query={headline: domain }
  //var userdomain=String(domain);
  // const headline = req.body.domain
  // const {description}= req.body
  //const tr = console.log(domain.toString())
  ...
  //const jwt = require("jsonwebtoken");
    ...
    //
    // // 
    const show = await User.find({domain: req.body.domain})
        console.log(show);
        res.json({data:show})
        if (!show) {
          res.status(400).json({
...
app.post("/empBrowse", async (req, res) => {
  try {
  const { token } = req.body;
  //const tr = console.log(domain)
  // const query={headline: domain }
